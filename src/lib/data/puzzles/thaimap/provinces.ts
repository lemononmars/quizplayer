export const provinceDict = {
 ...
 export const numProvinces:number = Object.keys(provinceDict).length
 export const provinceEN: string[] = Object.keys(provinceDict)
 export const provinceTH: string[] = Object.values(provinceDict)